...
class AddCello extends StatefulWidget {
  @override
  _AddCelloState createState() => _AddCelloState();
}

class _AddCelloState extends State<AddCello> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection("Cello");
