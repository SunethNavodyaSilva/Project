...
class UpdateCello extends StatefulWidget {
  @override
  _UpdateCelloState createState() => _UpdateCelloState();
}

class _UpdateCelloState extends State<UpdateCello> {
  ...
  CollectionReference collect = Firestore.instance.collection("Cello");
