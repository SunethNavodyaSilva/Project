...
class AddThabla extends StatefulWidget {
  @override
  _AddThablaState createState() => _AddThablaState();
}

class _AddThablaState extends State<AddThabla> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection("Thabla");
