...
class UpdateThabla extends StatefulWidget {
  @override
  _UpdateThablaState createState() => _UpdateThablaState();
}

class _UpdateThablaState extends State<UpdateThabla> {
  ...
  CollectionReference collect = Firestore.instance.collection("Thabla");
