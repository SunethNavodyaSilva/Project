...
class AddOrgan extends StatefulWidget {
  @override
  _AddOrganState createState() => _AddOrganState();
}

class _AddOrganState extends State<AddOrgan> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection("Organ");
