...
class UpdateGuitar extends StatefulWidget {
  @override
  _UpdateGuitarState createState() => _UpdateGuitarState();
}

class _UpdateGuitarState extends State<UpdateGuitar> {
  ...
  CollectionReference collect = Firestore.instance.collection("Guitar");
