...
class UpdateSaxophone extends StatefulWidget {
  @override
  _UpdateSaxophoneState createState() => _UpdateSaxophoneState();
}

class _UpdateSaxophoneState extends State<UpdateSaxophone> {
  ...
  CollectionReference collect = Firestore.instance.collection("Saxophone");
