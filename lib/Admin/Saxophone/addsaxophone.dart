...
class AddSaxophone extends StatefulWidget {
  @override
  _AddSaxophoneState createState() => _AddSaxophoneState();
}

class _AddSaxophoneState extends State<AddSaxophone> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection("Saxophone");
