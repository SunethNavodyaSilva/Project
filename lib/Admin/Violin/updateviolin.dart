...
class UpdateViolin extends StatefulWidget {
  @override
  _UpdateViolinState createState() => _UpdateViolinState();
}

class _UpdateViolinState extends State<UpdateViolin> {
  ...
  CollectionReference collect = Firestore.instance.collection("Violin");
