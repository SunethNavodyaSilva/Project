...
class AddViolin extends StatefulWidget {
  @override
  _AddViolinState createState() => _AddViolinState();
}

class _AddViolinState extends State<AddViolin> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection("Violin");
